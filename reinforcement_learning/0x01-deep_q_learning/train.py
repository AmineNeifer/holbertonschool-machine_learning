...
# policy. Another popular one is Boltzmann-style exploration:
...
# Okay, now it's time to learn something! We capture the interrupt exception
# so that training can be prematurely aborted.
# Notice that now you can use the built-in
# Keras callbacks!
